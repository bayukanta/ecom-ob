...
using OB_Net_Core_Tutorial.Interface;
using OB_Net_Core_Tutorial.Jobs;
using Quartz;
using Quartz.Impl;
...
namespace OB_Net_Core_Tutorial.Service
{
    public class SchedulerService : ISchedulerService, IDisposable
    {
        ...
        {
            var logTime = _configuration.GetValue<string>("Schedule:LogTimeJob");
